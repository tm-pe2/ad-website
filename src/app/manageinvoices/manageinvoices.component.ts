...
export class ManageinvoicesComponent implements OnInit {
  ...
  public invoices = 
  [{id:1,CustomerName:"Chrisse Sulter",SupplierID:1,Date:"3/23/2021",GasAmount:820,ElectricityAmount:0,Price:577,Tax:13.03, ClientType: "Business", StatusID: 3, Status: "Paid"},
  {"id":2,"CustomerName":"Boone Bodle","SupplierID":2,"Date":"3/18/2021","GasAmount":0,ElectricityAmount:685,"Price":444,"Tax":13.04, ClientType: "Private", StatusID: 2, Status: "Pending"},
  {"id":3,"CustomerName":"Willie Renison","SupplierID":2,"Date":"12/6/2021","GasAmount":0,ElectricityAmount:763,"Price":167,"Tax":5.75, ClientType: "Private", StatusID: 2, Status: "Pending"},
  ...
  public open(id: number): void {
    ...
    this.invoices.forEach(function (inv) {
      if (inv.id == id) {
        invoice = new Invoice(inv.id, inv.CustomerName, inv.SupplierID.toString(), inv.Date, "", inv.GasAmount, inv.ElectricityAmount, inv.Price, inv.Tax, "", inv.StatusID, inv.Status);
      }
    });
